        ...
        try {
            const response = await fetch("/api/aulas", {
                ...
                body: JSON.stringify({
                    ...
                    modulo: parseInt(formData.id_modulo),
            ...
            <div className="flex flex-col gap-4 p-8 text-black w-3/5 h-5/6 items-center rounded-lg border bg-slate-200 justify-center overflow-scroll">
                ...
                {loading ? (
                    ...
                    <form onSubmit={handleSubmit} className="w-full">
                        ...
                        <div className="mb-4">
                            <label htmlFor="hora_inicio" className="block text-gray-600">Hora Início</label>
                            <input
                                type="time"
                                id="hora_inicio"
                                name="hora_inicio"
                        ...
                        <div className="mb-4">
                            <label htmlFor="id_modulo" className="block text-gray-600">Módulo</label>
                            <select
                                id="id_modulo"
                                name="id_modulo"
                        ...
                        <div className="mb-4">
                            <label htmlFor="aviao_usado" className="block text-gray-600">Avião</label>
                            <select
                                id="aviao_usado"
                                name="aviao_usado"
