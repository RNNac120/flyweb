...
export default function CadastrarCompetencia() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [aulasResponse] = await Promise.all([
                    fetch("/api/aulas"),
                ]);
            ...
            <div className="flex flex-col gap-4 p-8 text-black w-3/5 h-5/6 items-center rounded-lg border bg-slate-200 justify-center overflow-scroll">
                ...
                {loading ? (
                    ...
                    <form onSubmit={handleSubmit} className="w-full">
                        ...
                        <div className="mb-4">
                            <label htmlFor="tipo_comp" className="block text-gray-600">Nome da Competência</label>
                            <input
                                id="tipo_comp"
                                name="tipo_comp"
                        ...
                        <div className="mb-4">
                            <label htmlFor="aula" className="block text-gray-600">Aula</label>
                            <select
                                id="aula"
                                name="aula"
                                value={formData.aula}
                        ...
                        <div className="mb-4">
                            <label htmlFor="comentarios" className="block text-gray-600">Comentário</label>
                            <input
                                id="comentarios"
                                name="comentarios"
