    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`/api/aulas/${id_aula}`, {
                ...
                body: JSON.stringify({
                    ...formData,
                    modulo: parseInt(formData.modulo),
                    nota: parseInt(formData.nota),
                    freq_radio: parseFloat(formData.freq_radio),
                }),
            });
        ...
        <main className="p-2 flex h-screen bg-sky-700 justify-between items-center">
            ...
            <div className="flex flex-col p-8 text-black w-3/5 h-5/6 items-center rounded-lg border bg-slate-200 justify-center overflow-scroll">
                ...
                <form onSubmit={handleSubmit} className="w-full">
                    <div className="mb-4">
                        <label htmlFor="dia_aula" className="block text-gray-600">Data da Aula</label>
                        <input
                            type="date"
                            id="dia_aula"
                            name="dia_aula"
                    ...
                    <div className="mb-4">
                        <label htmlFor="hora_inicio" className="block text-gray-600">Hora de Início</label>
                        <input
                            type="time"
                            id="hora_inicio"
                            name="hora_inicio"
                    ...
                    <div className="mb-4">
                        <label htmlFor="hora_fim" className="block text-gray-600">Hora de Término</label>
                        <input
                            type="time"
                            id="hora_fim"
                            name="hora_fim"
                    ...
                    <div className="mb-4">
                        <label htmlFor="aviao_usado" className="block text-gray-600">Avião Usado</label>
                        <select
                            id="aviao_usado"
                            name="aviao_usado"
                    ...
                    <div className="mb-4">
                        <label htmlFor="aluno" className="block text-gray-600">Aluno</label>
                        <select
                            id="aluno"
                            name="aluno"
                    ...
                    <div className="mb-4">
                        <label htmlFor="instrutor" className="block text-gray-600">Instrutor</label>
                        <select
                            id="instrutor"
                            name="instrutor"
                    ...
                    <div className="mb-4">
                        <label htmlFor="modulo" className="block text-gray-600">Módulo</label>
                        <input
                            type="text"
                            id="modulo"
                            name="modulo"
                    ...
                    <div className="mb-4">
                        <label htmlFor="freq_radio" className="block text-gray-600">Frequência do Rádio</label>
                        <input
                            type="text"
                            id="freq_radio"
                            name="freq_radio"
