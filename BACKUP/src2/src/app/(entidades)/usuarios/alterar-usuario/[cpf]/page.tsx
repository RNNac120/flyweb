    ...
    <main className="p-2 flex h-screen bg-sky-700 justify-between items-center">
      ...
      <div className="flex flex-col p-8 text-black w-3/5 h-5/6 items-center rounded-lg border bg-slate-200 justify-center overflow-scroll">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          <div className="mb-4">
            <label htmlFor="nome" className="block text-gray-600">
              Nome
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="data_nasc" className="block text-gray-600">
              Data de Nascimento
            </label>
            <input
              type="date"
          ...
          <div className="mb-4">
            <label htmlFor="carteira_anac" className="block text-gray-600">
              Carteira ANAC
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="carteira_mec" className="block text-gray-600">
              Carteira de Mecânico
            </label>
            <input
              type="text"
              id="carteira_mec"
          ...
          <div className="mb-4">
            <label htmlFor="salario" className="block text-gray-600">
              Salário
            </label>
            <input
              type="number"
