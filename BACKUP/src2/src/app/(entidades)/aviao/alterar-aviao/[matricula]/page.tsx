    ...
    <main className="p-2 flex h-screen bg-sky-700 justify-between items-center">
      ...
      <div className="flex flex-col p-8 text-black w-3/5 h-5/6 items-center rounded-lg border bg-slate-200 justify-center">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          <div className="mb-4">
            <label htmlFor="matricula" className="block text-gray-600">
              Matrícula
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="horas_voadas" className="block text-gray-600">
              Horas Voadas
            </label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label htmlFor="data_prox_mnt" className="block text-gray-600">
          ...
          <div className="mb-4">
            <label htmlFor="fabricante" className="block text-gray-600">
              Fabricante
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="modelo_anv" className="block text-gray-600">
              Modelo
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="num_hangar" className="block text-gray-600">
              Número do Hangar
            </label>
            <input
              type="number"
