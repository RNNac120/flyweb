  ...
  if (req.method === "DELETE") {
    ...
    try {
      ...
      const aviaoAtualizado = await prisma.aviao.update({
        where: { matricula: String(matricula) },
        data: {
          horas_voadas: horas_voadas !== undefined ? Number.parseInt(horas_voadas, 10) : aviaoExistente.horas_voadas,
          ...
          num_hangar: num_hangar !== undefined ? Number.parseInt(num_hangar, 10) : aviaoExistente.num_hangar,
        },
      })
