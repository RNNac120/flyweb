    ...
    try {
      ...
      const aulaAtualizada = await prisma.aula.update({
        ...
        data: {
          ...
          modulo: modulo !== undefined ? Number.parseInt(modulo, 10) : aulaExistente.modulo,
          nota: nota !== undefined ? Number.parseInt(nota, 10) : aulaExistente.nota,
          freq_radio: freq_radio !== undefined ? Number.parseFloat(freq_radio) : aulaExistente.freq_radio,
        },
      })
